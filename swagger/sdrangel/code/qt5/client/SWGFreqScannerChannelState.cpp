...
SWGFreqScannerChannelState::fromJsonObject(QJsonObject &pJson) {
	...
	::SWGSDRangel::setValue(&active_count, pJson["activeCount"], "qint32", "");
...
SWGFreqScannerChannelState::asJsonObject() {
	...
	if(m_active_count_isSet){
        obj->insert("activeCount", QJsonValue(active_count));
    } 
...
qint32
SWGFreqScannerChannelState::getActiveCount() {
    return active_count;
}
void
SWGFreqScannerChannelState::setActiveCount(qint32 active_count) {
    this->active_count = active_count;
    this->m_active_count_isSet = true;
}
