...
public:
	...
	class MsgClearHits : public Message {
        MESSAGE_CLASS_DECLARATION

    public:
        static MsgClearHits* create()
        {
            return new MsgClearHits();
        }
	...
	class MsgClearHitsReport : public Message {
        MESSAGE_CLASS_DECLARATION

    public:
        static MsgClearHitsReport* create()
        {
            return new MsgClearHitsReport();
        }
...
private:
	...
	QMap<qint64, int> m_frequencyHits;
